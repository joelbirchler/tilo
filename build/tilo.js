...
require.define("/src/spritesheet.js",function(require,module,exports,__dirname,__filename,process,global){exports.spritesheet = function(imageSrcOrObject, map, px) {
  var that = this,
    imageSrc,
    image;
...
require.define("/src/board.js",function(require,module,exports,__dirname,__filename,process,global){exports.board = function(map, width, height) {
  var x, y;
...
require.define("/images/spritesheet-64.json",function(require,module,exports,__dirname,__filename,process,global){module.exports = {
  'image': 'images/spritesheet-64.png',
  'px': 64,
  'map': {
    'wood': [0, 0, 64, 128],
    'woodScreen': [64, 0, 64, 128],
    'goldStone': [128, 0, 64, 128],
    'grayStone': [192, 0, 64, 128],
    'leaves': [256, 0, 64, 128],
    'goldStoneWater': [320, 64, 64, 64],
    'grayStoneWater': [384, 64, 64, 64],
    'goldStoneFloor': [320, 0, 64, 64],
    'grayStoneFloor': [384, 0, 64, 64],
    'roughtStoneFloor': [448, 0, 64, 64],
    'goldStoneFloor': [448, 64, 64, 64]
  }
};

});

require.define("/src/tilo.js",function(require,module,exports,__dirname,__filename,process,global){var tilo = {
